...
ActiveRecord::Schema.define(version: 2018_08_23_140346) do
  ...
  create_table "books_authors", force: :cascade do |t|
    ...
    t.index ["author_id", "book_id"], name: "index_books_authors_on_author_id_and_book_id"
